		...
		for(var i=0;i<data['feesList'].length;i++){
			...
			if(data['feesList'][i]['feeTypeNum']=='0'){
				...
				if(data['feesList'][i]['byOrder']=='1'){
					var oDd=$("<dd class='clearfix Fees'><span class='name fl'>"+data['feesList'][i]['feeTypeEname']+"</span><span class='val fr'><span class='currencys'>"+arrCurrency[data['feesList'][i]['currency']]+"</span><input type='number' value='100'/></span></dd>");
					oDd.find('input').val(data['feesList'][i]['orderPrice']);
				}else{
					var oDd=$("<dd class='clearfix Fees'><span class='name fl'>"+data['feesList'][i]['feeTypeEname']+"</span><span class='val fr'><span class='currencys'>"+arrCurrency[data['feesList'][i]['currency']]+"</span><input type='number' value='100' class='v1'/>*<span class='num1'>1</span>+<span class='currencys'>"+arrCurrency[data['feesList'][i]['currency']]+"</span><input type='number' value='100' class='v2'>*<span class='num2'>1</span>=<span class='currencys2 currencys'>"+arrCurrency[data['feesList'][i]['currency']]+"</span><span class='total2'>200</span></span></dd>");
					if($('#num20GP').length){
