...
var langText={
	'US':{
		...
		'company2':'Carrier:',
		'search':'Search',
		'inquiry':'Direct inquiry to HQ',
		'hot':'Inquiry Hotline:',
		'Freight query':'Freight',
		'Inquiry management':'Manage',
		'logistics':'Logistics',
		'account':'My account',
		'current_inquiry':'No_inquiry',
		'Box_type_Num':'Box_Type_Num:',
		'Completed':'Have_inquiry',
		'canceled':'Canceled',
		'cancel':'Cancel',
		'complete':'Complete',
		...
		'customer':'customer:',
		'booking':'booked:',
		'inquirying':'inquiryed:',
		'field1':'HQ not offer',
		'field1_2':'HQ has offer',
		'field2':'customer not offer',
		'field2_2':'customer has offer',
		'field3':'Inquiry',
		'mouths':'',
