...
//		        	$(ele).siblings('.val')[0].innerHTML=`${selectOneObj.value.substring(0,4)}-${selectTwoObj.value.substring(0,selectTwoObj.value.length-1)}-${selectThreeObj.value.substring(0,selectThreeObj.value.length-1)}`;
//		        }
//		});
//	})
//})
